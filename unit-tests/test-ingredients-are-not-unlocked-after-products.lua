...
local test_ingredients_are_not_unlocked_after_products = function()
  add_ignores()
...
return {test_ingredients_are_not_unlocked_after_products = test_ingredients_are_not_unlocked_after_products}
