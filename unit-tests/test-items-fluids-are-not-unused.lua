...
local test_item_fluids_are_not_unused = function()
  ...
  table.insert(recipe_filters, { -- TODO remove?
...
return {test_item_fluids_are_not_unused = test_item_fluids_are_not_unused}
