...
local entities_to_ignore_recipe = { -- TODO review
  ["rocket-silo"] = true,
...
local test_entities_have_item_and_craftable_recipe = function()
...
return {test_entities_have_item_and_craftable_recipe = test_entities_have_item_and_craftable_recipe}
