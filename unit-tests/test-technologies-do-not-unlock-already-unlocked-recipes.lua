...
local test_technologies_do_not_unlock_already_unlocked_recipes = function()
...
return {test_technologies_do_not_unlock_already_unlocked_recipes = test_technologies_do_not_unlock_already_unlocked_recipes}
