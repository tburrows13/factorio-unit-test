...
local test_recipes_can_be_unlocked_by_technologies = function()
...
return {test_recipes_can_be_unlocked_by_technologies = test_recipes_can_be_unlocked_by_technologies}
