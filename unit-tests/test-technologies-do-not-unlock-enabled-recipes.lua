...
local test_technologies_do_not_unlock_enabled_recipes = function()
...
return {test_technologies_do_not_unlock_enabled_recipes = test_technologies_do_not_unlock_enabled_recipes}
