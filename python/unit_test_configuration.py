...
class UnitTestConfiguration:
    ...
    @classmethod
    def __iter__(
        cls: UnitTestConfiguration,
    ) -> Iterable[tuple[str, list[str], dict[str, bool]]]:
...
###############################################################################
# Angels petrochem
UnitTestConfiguration.addDefaultSetting(
    "startup", "angels-enable-converter", False
)  # We do not test the converter valve as this is just there for compatibility
...
UnitTestConfiguration.addDefaultSetting(
    "startup", "bobmods-power-fluid-generator", True
)
...
UnitTestConfiguration.addDefaultSetting(
    "startup", "bobmods-assembly-chemicalplants", True
)
UnitTestConfiguration.addDefaultSetting("startup", "bobmods-assembly-oilfurnaces", True)
UnitTestConfiguration.addDefaultSetting(
    "startup", "bobmods-assembly-multipurposefurnaces", True
)
UnitTestConfiguration.addDefaultSetting(
    "startup", "bobmods-assembly-electrolysers", True
)
UnitTestConfiguration.addDefaultSetting(
    "startup", "bobmods-assembly-distilleries", True
)
UnitTestConfiguration.addDefaultSetting("startup", "bobmods-assembly-centrifuge", True)
UnitTestConfiguration.addDefaultSetting(
    "startup", "bobmods-assembly-electronicmachines", True
)

# BobLogistics
UnitTestConfiguration.addDefaultSetting(
    "startup", "bobmods-logistics-disableroboports", True
)
UnitTestConfiguration.addDefaultSetting(
    "startup", "bobmods-logistics-flyingrobotframes", True
)
UnitTestConfiguration.addDefaultSetting("startup", "bobmods-logistics-robotparts", True)
UnitTestConfiguration.addDefaultSetting(
    "startup", "bobmods-logistics-inserteroverhaul", True
)
UnitTestConfiguration.addDefaultSetting(
    "startup", "bobmods-logistics-beltoverhaul", True
)

# BobEnemies
UnitTestConfiguration.addDefaultSetting(
    "startup", "bobmods-enemies-enableartifacts", True
)
...
# BobOther
UnitTestConfiguration.addDefaultSetting(
    "startup", "bobmods-burnerphase", False
)  # TODO: add testing cases if we want to support this
...
UnitTestConfiguration.addDefaultSetting(
    "startup", "bobmods-modules-enable-modules-lab", True
)

###############################################################################
### SPECIAL VANILLA                                                         ###
###############################################################################
UnitTestConfiguration.addConfiguration(
...
UnitTestConfiguration.addConfiguration(
    "BA (BobPower non-default + overhaul)",
    [
        "angelsrefining",
        "angelspetrochem",
        "angelssmelting",
...
UnitTestConfiguration.addConfiguration(
    "BA (BobPower non-default + components)",
    [
        "angelsrefining",
        "angelspetrochem",
        "angelssmelting",
...
UnitTestConfiguration.addConfiguration(
    "BA (BobPower non-default + technology)",
    [
        "angelsrefining",
        "angelspetrochem",
        "angelssmelting",
...
UnitTestConfiguration.addConfiguration(
    "BA (BobAssembly non-default + overhaul)",
    [
        "angelsrefining",
        "angelspetrochem",
        "angelssmelting",
...
UnitTestConfiguration.addConfiguration(
    "BA (BobLogistics non-default + overhaul)",
    [
        "angelsrefining",
        "angelspetrochem",
        "angelssmelting",
...
UnitTestConfiguration.addConfiguration(
    "BA (BobRevamp non-default + overhaul)",
    [
        "angelsrefining",
        "angelspetrochem",
        "angelssmelting",
...
UnitTestConfiguration.addConfiguration(
    "BA (Bob other non-default + overhaul)",
    [
        "angelsrefining",
        "angelspetrochem",
        "angelssmelting",
...
UnitTestConfiguration.addConfiguration(
    "BA (BobModules non-default + technology)",
    [
        "angelsrefining",
        "angelspetrochem",
        "angelssmelting",
